...
2. e.g. `[64, 255, 0, 8]`
3. Seed Samples - [Entropy-Seeds.txt](https://github.com/peetzweg/entropretty/samples/Procedural-seeds.txt)
...
5. Seeds Samples - [Personal_Id-Seeds.txt](https://github.com/peetzweg/entropretty/samples/ProceduralPersonal-seeds.txt)
...
3. Seeds Samples - [Account_Id-Seeds.txt](https://github.com/peetzweg/entropretty/samples/ProceduralAccount-seeds.txt)
