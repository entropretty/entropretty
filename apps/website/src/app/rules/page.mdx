...
<div className="fixed top-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-sm border-b border-border">
  <div className="mx-auto max-w-4xl px-4 sm:px-4 py-4">
    <div className="flex items-center justify-between">
      ...
      <a href="https://app.entropretty.com/">
        <RainbowButton className="text-sm px-4 sm:px-6 py-2 h-10 flex items-center justify-center">
...
2. e.g. `[64, 255, 0, 8]`
3. Seed Samples - [Entropy-Seeds.txt](https://github.com/peetzweg/entropretty/blob/main/samples/Procedural-seeds.txt)
...
5. Seeds Samples - [Personal_Id-Seeds.txt](https://github.com/peetzweg/entropretty/blob/main/samples/ProceduralPersonal-seeds.txt)
...
3. Seeds Samples - [Account_Id-Seeds.txt](https://github.com/peetzweg/entropretty/blob/main/samples/ProceduralAccount-seeds.txt)
