  ...
  <div className="mx-auto max-w-4xl px-4 py-4">
    <div className="flex items-center justify-between">
      ...
      <a href="https://app.entropretty.com/">
        <RainbowButton className="text-sm px-6 py-2 h-10 flex items-center justify-center">
          <span className='m-0 '>Launch App</span>
        </RainbowButton>
      </a>
    </div>
  </div>
...
For your algorithm you can choose one of 3 different seed types as the input. Depending on your design goals, certain seed types may be more suitable than others.
For most cases, we recommend starting with the simplest option: Entropy.
