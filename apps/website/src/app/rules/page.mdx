...
**_Black & White Designs_**

<img
  className="mx-auto w-full"
  src="/guidelines/BlackAndWhiteExamples.png"
  alt="Examples of good and bad distinguishability"
/>
...
<img
  className="mx-auto w-full"
  src="/guidelines/GrayscaleExamples.png"
  alt="Examples of good and bad distinguishability"
/>
...
<img
  className="mx-auto w-full"
  src="/guidelines/ColorExamples.png"
  alt="Examples of good and bad distinguishability"
/>

**_Easy to Distinguish_**

<img
  className="mx-auto w-full md:w-3/4"
  src="/guidelines/TooSimilar.png"
  alt="Examples of good and bad distinguishability"
/>

**_Possible to Tattoo_**

<img
  className="mx-auto w-full md:w-3/4"
  src="/guidelines/TooFineDetails.png"
  alt="Possible to Tattoo"
/>
...
<img
  className="mx-auto w-full md:w-3/4"
  src="/guidelines/UnknownOrientation.png"
  alt="Unknown Orientation"
/>
...
Returns a bigint representing the seed. Useful for transforming a _Procedural Personal_ seed into a single integer number representation aka the Personal Id/Citizen Id.
